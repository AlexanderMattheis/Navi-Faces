# Navi Faces
A very old project integrated in my unfinished strategy game **The Navigators** which was written by using the MonoGame-framework. The architecture was too complicated
